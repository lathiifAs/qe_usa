                        ...
                        <form action="{{ route('quality_express/store') }}" method="post">
                            ...
                            <div class="row col-lg-12 m-2" style="margin-top: 15px">
                                <div class="col-lg-4">
                                    ...
                                    <textarea name="container_no" style="white-space: pre-wrap;" size="2" cols="50" rows="10">{!! old('container_no') !!}</textarea>
                                    @error('container_no')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <textarea name="no_of_pkgs" class="summernote"  style="white-space: pre-wrap;" size="2" cols="100" rows="10">{!! old('no_of_pkgs') !!}</textarea>
                                    @error('no_of_pkgs')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
