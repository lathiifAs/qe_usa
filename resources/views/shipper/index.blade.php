...
<div class="mb-3">
    <nav aria-label="breadcrumb">
        <h6 class="font-weight-bolder text-white mb-0">Shipper</h6>
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Shipper</li>
        </ol>
    </nav>
</div>
      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
              <div class="row">
                  <div class="col-lg-10">
                    <h6 class="mt-2">Shipper</h6>
                  </div>
                <div class="col-lg-2" style="text-align: right">
                <a href="{{ route('master/shipper/add') }}" class="btn btn-primary"> Add Data</a>
                </div>
              </div>
          </div>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" width="80%">Shipper</th>
                    <th class="text-secondary opacity-7" width="10%"></th>
                  </tr>
                </thead>
                <tbody>
                    @forelse ($shipper as $key => $shp)
                    <tr>
