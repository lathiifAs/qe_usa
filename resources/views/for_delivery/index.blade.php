...
<div class="white-box">
    <h3 class="box-title">For Delivery</h3>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#"> <i class="fa fa-database"></i> Master Data</a></li>
          <li class="breadcrumb-item active" aria-current="page">For Delivery</li>
        </ol>
    </nav>
</div>
        ...
        <div class="card mb-4">
          <div class="card-header pb-0">
              <div class="row">
                ...
                <a href="{{ route('master/for_delivery/add') }}" class="btn btn-primary"> Add Data</a>
                </div>
              </div>
          </div>
          <hr>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" width="80%">For Delivery</th>
                    <th class="text-secondary opacity-7" width="10%"></th>
                  </tr>
                </thead>
                <tbody>
                    @forelse ($for_delivery as $key => $cn)
                    <tr>
