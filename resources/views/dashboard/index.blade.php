                        ...
                        <div class="white-box">
                            ...
                            <div class="task-widget t-a-c">
                                ...
                                <div class="task-assign font-16">
                                    ...
                                    <ul class="list-inline">
                                        <li class="p-l-0">
                                            <img src="{{ URL('cubic_template/plugins/images/users/1.png') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave">
                                        </li>
                                        <li>
                                            <img src="{{ URL('cubic_template/plugins/images/users/2.png') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave">
                                        </li>
                                        <li>
                                            <img src="{{ URL('cubic_template/plugins/images/users/3.png') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave">
                                        </li>
                                        <li class="p-r-0">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);" class="text-link">Quality Express</a></td>
                        ...
                        <div class="white-box">
                            <div class="task-widget2">
                                <div class="task-image">
                                    <img src="{{ URL('cubic_template/plugins/images/task.jpg') }}" alt="task" class="img-responsive">
                    ...
                    <div class="col-md-4">
                        <div class="white-box chat-widget">
                            ...
                            <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                                <li>
                                    <div class="chat-image"> <img alt="male" src="{{ URL('cubic_template/plugins/images/users/hanna.jpg') }}"> </div>
                                    <div class="chat-body">
                                        <div class="chat-text">
                                            <p><span class="font-semibold">Quality Express</span> Hey Daniel, This is just a sample chat. </p>
                                        </div>
                                        <span>2 Min ago</span>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="chat-body">
                                        <div class="chat-text">
                                            <p><span class="font-semibold">Quality Express</span> Bye now. </p>
                                        </div>
                                        <span>1 Min ago</span>
                                    </div>
                                </li>
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ URL('cubic_template/plugins/images/users/1.jpg') }}" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ URL('cubic_template/plugins/images/users/2.jpg') }}" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ URL('cubic_template/plugins/images/users/3.jpg') }}" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ URL('cubic_template/plugins/images/users/4.jpg') }}" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ URL('cubic_template/plugins/images/users/5.jpg') }}" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ URL('cubic_template/plugins/images/users/6.jpg') }}" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
